...
public class IRNPReplyErrorWithdrawMessage extends IRNPMessage {
	...
	public IRNPReplyErrorWithdrawMessage() {
		vers = 0x01;
		flags = 0x00;
	...
	public void encode() throws IRNPProtocolViolationException {
		if(senderTemplate == null || receiverTemplate == null || flowBandwidthConfirm == null || asPath == null || errorSpec == null) {
			System.out.println("IRNP Reply Error Withdraw Message misses parts, cannot be encoded");
			return;
		}
		...
		System.out.println("IRNP Reply Error Withdraw Message encoding accomplished");
	}
