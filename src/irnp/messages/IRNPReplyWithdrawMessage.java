...
public class IRNPReplyWithdrawMessage extends IRNPMessage {
	...
	public IRNPReplyWithdrawMessage() {
		vers = 0x01;
		flags = 0x00;
	...
	public void encode() throws IRNPProtocolViolationException {
		if(senderTemplate == null || receiverTemplate == null || flowBandwidthConfirm == null || asPath == null) {
			System.out.println("IRNP Reply Withdraw Message misses parts, cannot be encoded");
			return;
		}
		...
		System.out.println("IRNP Reply Withdraw Message encoding accomplished");
	}
